...
export const alt = "Burbank Sports Inc. - Chicagoland's Team Specialist Since 1970";
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Custom Shirts, Jerseys &amp; Sportswear in Burbank, IL
          </p>
          ...
          >
            {["Custom Shirts", "Team Jerseys", "Letterman Jackets", "Screen Printing"].map(
              (service) => (
                <div
                  key={service}
                  style={{
